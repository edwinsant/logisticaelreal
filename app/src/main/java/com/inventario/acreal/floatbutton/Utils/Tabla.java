...
public class Tabla
{
    ...
    public void agregarFilaTabla(ArrayList<String> elementos)
    {
        ...
        final TextView button = new TextView(actividad);
        ...
        button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
               ...
               int i = ((ViewGroup) row.getParent()).getId();
                TextView items = (TextView) tablerow.getChildAt(0);
                Toast.makeText(actividad, items.getText().toString() ,Toast.LENGTH_LONG).show();
                //db.borrarmaterialcodigo(items.getText().toString());
